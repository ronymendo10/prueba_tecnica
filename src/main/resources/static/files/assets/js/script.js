...
$('#styleSelector').append('' +
    ...
    /*'<ul>' +
        '<li>' +
            '<p class="selector-title main-title st-main-title"><b>CONSULTAS </b></p>' +
            '<span class="text-muted">Seleccione una opción de consulta</span>'+
        '</li>' +
        '<li>' +
...
'<ul>'+
    ...
    '<li class="text-center">' +
        '<span class="text-center f-18 m-t-15 m-b-15 d-block">Thank you for sharing 11 !</span>' +
